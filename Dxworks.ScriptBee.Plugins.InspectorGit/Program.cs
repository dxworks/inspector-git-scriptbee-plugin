...
namespace Dxworks.ScriptBee.Plugins.InspectorGit
{
    internal static class Program
    {
        ...
        private static (Dictionary<string, List<File>> wrongFiles, List<string> notFoundFiles) TestBlames(Repository repository)
        {
            ...
            Console.WriteLine($"Blame acurracy: matched {totalCorrectLines} / {totalLines}, {totalCorrectLines * 100 / totalLines}%");
