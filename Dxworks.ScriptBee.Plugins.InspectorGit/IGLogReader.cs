...
namespace Dxworks.ScriptBee.Plugins.InspectorGit
{
    public class IGLogReader
    {
        ...
        private static HunkDTO ReadHunk(string hunkLine)
        {
            ...
            return new HunkDTO(ParseLineRanges(addedLinesRanges, LineOperationDTO.Add),
                ParseLineRanges(deletedLinesRanges, LineOperationDTO.Delete));
        }

        private static List<LineChangeDTO> ParseLineRanges(string lineRanges, LineOperationDTO lineOperation)
        {
